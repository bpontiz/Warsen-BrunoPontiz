...
import noUserIcon from '../../Multimedia/noUserIcon.png';
...
export default function Contact() {
    ...
    return(
        <section className="sectionContactNoUser">
            <p className="pContactNoUserOops">Oops!</p>
            <img className='imgContactNoUser' src={noUserIcon} alt="Undefined user" />
            <Link to='/registered' className='linkContactNoUser'><p className='pContactNoUser'>Please log in first →</p></Link>
        </section>
    )
